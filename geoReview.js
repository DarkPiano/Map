...
export default class GeoReview {
    ...
    async onClick(coords){
        ...
        this.map.setBallonContent(form.innerHTML);
    }

    async onDocumentClick(e) {
        if (e.target.dataset.rote === 'review-add') {
